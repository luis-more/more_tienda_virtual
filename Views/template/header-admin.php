  ...
  <div class="wrapper">
    ...
    <div class="sidebar-wrapper" data-simplebar="true">
      <div class="sidebar-header">
        <div>
          <img src="<?php echo BASE_URL; ?>assets/images/logo.jpeg" class="logo-icon" alt="logo icon">
        </div>
        <div>
      ...
      <ul class="metismenu" id="menu">
        ...
        <li>
          <a href="<?php echo BASE_URL . 'categorias'; ?>">
            <div class="menu-title"><i class='fas fa-tags'></i> Catgorias</div>
          </a>
        </li>
        <li>
        ...
        <nav class="navbar navbar-expand">
          ...
          <div class="user-box dropdown">
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button"
              ...
              <img src="<?php echo BASE_URL; ?>assets/images/logo.jpeg" class="user-img" alt="user avatar">
