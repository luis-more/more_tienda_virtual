      ...
      <div class="w-100 d-flex justify-content-between">
        <div>
          ...
          <a class="navbar-sm-brand text-light text-decoration-none"
            href="mailto:info.angel@gmail.com">moreweb17@gmail.com</a>
          <i class="fa fa-phone mx-2"></i>
          <a class="navbar-sm-brand text-light text-decoration-none" href="tel:900 897 537">912815883</a>
        </div>
        <div>
      ...
      <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
        ...
        <div class="navbar align-self-center d-flex">
          ...
          <a class="nav-icon position-relative text-decoration-none" href="#" id="verCarrito">
            ...
            <span class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-util text-white"
              id="btnCantiadCarrito">0</span>
          </a>
          ...
          <!-- modal del usuario login -->

          <!-- fin del modal del usuario login -->
          <?php if(!empty($_SESSION['correoCliente'])) { ?>
          <a class="nav-icon position-relative text-decoration-none" href="<?php echo BASE_URL . 'clientes' ?>">
            <img class="img-thumbnail" src="<?php echo BASE_URL . 'assets/img/clientes/default.png'?>"
              alt="_LOGO-CLIENTE" width="50">
          </a>
          <?php } else { ?>
