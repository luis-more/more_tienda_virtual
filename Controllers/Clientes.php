...
class Clientes extends Controller
{
    ...
    {
            //capturams los datos del registro de usuario y le pasamos al modelo
                ...
                if(empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['clave'])){
                    ...
                    if(empty($verificar)){
                        ...
                        if( $data >0 ){
                            ...
                            $mensaje = array('msg' => 'Error al registarse', 'icono' => 'error');
                        }
                    }else{
...
//para logearte si exite post .........m3:50
    ...
    public function enviarCorreo()
    {
        if (isset($_POST['correo']) && isset($_POST['token'])) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('moreweb17@gmail.com', TITLE);
                $mail->addAddress($_POST['correo']);     //Add a recipient
                
                //Attachments para enviar archivos comprimidos
